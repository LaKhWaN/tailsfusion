...
export default ({
  ...
  description = "Get the best TailsFusion OS for your business or personal use. We provide the best TailsFusion OS for the best price.",
  plans = null,
  primaryButtonText = "Get Yours Now",
}) => {
  const defaultPlans = [
    // {
    //   name: "Personal",
    ...
    // },
    {
      ...
      price: ["$39", ".99/month"],
      oldPrice: "$49.99",
      description: "Perfect for your personal use.",
      features: [
        "2 Layer Security",
        "Encryption",
        "Access to limited applications",
      ],
      url: "coming-soon",
    },
    {
      ...
      price: ["$24", ".99/month"],
      oldPrice: "$30.00",
      description: "Perfect for your employees and business.",
      features: [
        "3 Layer Security",
        "Encryption",
            ...
            <Plan key={index} featured={plan.featured}>
              ...
              <PlanAction>
                <ActionButton as="a" href={plan.url}>
                  {plan.name == "Personal" ? "Coming Soon!" : primaryButtonText}
                </ActionButton>
              </PlanAction>
            </Plan>
          ))}
